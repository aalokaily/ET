							...
							while suffix_end_node != tree.root and f:
								...
								if left_position != right_position:
									...
									if deepest_matching_internal_node.depth - transition_node.depth <= depth_required:
										...
										#print ("OT_index was used to find approximate matrching by finding deepest_matching_internal_node", tree._edgeLabel(deepest_matching_internal_node, transition_node)[:30], suffix_errors)
									else:
